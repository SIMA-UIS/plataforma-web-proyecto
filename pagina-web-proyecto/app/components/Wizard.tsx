...
const Wizard = ({ course, onComplete, onCancel }: WizardProps) => {
  ...
  const renderStepper = () => {
    const steps = [
      ...
      "Aula Invertida", //"Prebriefing",
      "Taller de Habilidad", //"Briefing",
      "Experiencia de Alta Fidelidad", //"Debriefing",
      "Revisión",
    ];
          ...
          <div>
            {activeCardId === null && (
              <>
                ...
                <h3 className="text-3xl mb-2 font-bold">Experiencia de Alta Fidelidad</h3>
                <p className="mb-4 text-justify text-gray-600">
