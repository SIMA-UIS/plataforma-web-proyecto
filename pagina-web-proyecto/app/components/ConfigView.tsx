...
export default function ConfigView({ onBack }: ConfigViewProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      if (isEditing && selectedUser) {
        // EDIT
        await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/${selectedUser.username}`, {
          method: "PUT",
          headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/courses/deleteUserFromCourses/${userToDelete.username}`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        }
      ...
      await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/${userToDelete.username}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
